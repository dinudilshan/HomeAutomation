...
<html class="fixed">
	<head>
		...
		<title>Smart Wave | Device Settings | SYNCY WAVE LTD.</title>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span> Device Settings</span></li>
							</ol>
						...
						<div class="col-md-6 ">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Add Devices</h2>
								</header>
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12">
                                            <form id="add-device-form" action="./includes/process-add-device.php" method="post" role="form" class="form-horizontal form-bordered">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="DeviceName">Device Name</label>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="DeviceID">Device ID</label>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label" for="add-device-submit"></label>
                                                    <div class="col-md-3">
                                                        <input type="submit" class="form-control btn btn-default" name="add-device-submit" id="add-device-submit">
                                                    </div>
                                                </div>
